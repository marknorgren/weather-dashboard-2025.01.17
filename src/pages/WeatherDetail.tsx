    ...
    <div className='bg-neutral-light min-h-screen'>
      ...
      <div className='container mx-auto p-4'>
        ...
        <div className='bg-white rounded-lg shadow-lg p-6 mt-4' data-testid='weather-detail'>
          <h1 className='text-4xl font-bold mb-6' data-testid='city-name'>
            {weather.city}
          </h1>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-2 gap-4 mt-6'>
                <div>
                  ...
                  <p className='text-xl' data-testid='humidity'>
                    {weather.humidity}%
                  </p>
                </div>
                <div>
                  <p className='text-gray-600'>Wind Speed</p>
                  <p className='text-xl' data-testid='wind-speed'>
                ...
                <div>
                  ...
                  <p className='text-xl' data-testid='pressure'>
